...
# Extended catalogue of well-known TCP service ports used by --mode1 output.
# The list intentionally covers 200 entries to provide richer status messages
# without depending on external lookups at runtime.
